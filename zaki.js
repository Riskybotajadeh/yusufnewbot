...
m.reply(mess.wait)
zaki.sendMessage(m.chat, { image: { url: https://waifu.pics/api/sfw/${command} }, caption: 'Generate Random ' + command }, { quoted: m })
}
break
		...
		case 'igeh': case 'instagram2': case 'ig2': case 'igdl2': {
                ...
                zaki.sendMessage(m.chat, { video: { url: anu.data[0] } }, { quoted: m })
            }
            break
